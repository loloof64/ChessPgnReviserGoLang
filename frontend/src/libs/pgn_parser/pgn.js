...
var pgnReader = function (configuration, chess) {
    ...
    var load_pgn = function () {
        ...
        if (definedPositionInHeader) {
            ...
            that.startupPosition = that.headers.FEN;
            that.finalPosition = that.headers.FEN;
        }
        else {
            const originalPosition = 'rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1';
            that.startupPosition = originalPosition;
            that.finalPosition = originalPosition;
        }
